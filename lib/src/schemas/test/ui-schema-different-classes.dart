...
class LayoutElementOptions {
    ControlFormattingOptions? controlFormattingOptions;
    ...
    factory LayoutElementOptions.fromJson(Map<String, dynamic> json) => LayoutElementOptions(
        controlFormattingOptions: json["controlFormattingOptions"] == null ? null : ControlFormattingOptions.fromJson(json["controlFormattingOptions"]),
        customOptions: Map.from(json["customOptions"]!).map((k, v) => MapEntry<String, dynamic>(k, v)),
        enumOptions: json["enumOptions"] == null ? null : EnumOptions.fromJson(json["enumOptions"]),
        fileUploadOptions: json["fileUploadOptions"] == null ? null : FileUploadOptions.fromJson(json["fileUploadOptions"]),
        inputOptions: json["inputOptions"] == null ? null : InputOptions.fromJson(json["inputOptions"]),
        tagsOptions: json["tagsOptions"] == null ? null : TagsOptions.fromJson(json["tagsOptions"]),
        cssClass: json["cssClass"],
        nativeSubmitOptions: json["nativeSubmitOptions"] == null ? null : NativeSubmitSettings.fromJson(json["nativeSubmitOptions"]),
    );

    Map<String, dynamic> toJson() => {
        "controlFormattingOptions": controlFormattingOptions?.toJson(),
        "customOptions": Map.from(customOptions!).map((k, v) => MapEntry<String, dynamic>(k, v)),
        "enumOptions": enumOptions?.toJson(),
        "fileUploadOptions": fileUploadOptions?.toJson(),
        "inputOptions": inputOptions?.toJson(),
        "tagsOptions": tagsOptions?.toJson(),
        "cssClass": cssClass,
        "nativeSubmitOptions": nativeSubmitOptions?.toJson(),
    };
}
...
class TagsOptions {
    ...
    factory TagsOptions.fromJson(Map<String, dynamic> json) => TagsOptions(
