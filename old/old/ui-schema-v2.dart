...
//
//     final uiSchemaV2 = uiSchemaV2FromJson(jsonString);

import 'dart:convert';

UiSchemaV2Model uiSchemaV2FromJson(String str) =>
    UiSchemaV2Model.fromJson(json.decode(str));

String UiSchemaV2ToJson(UiSchemaV2Model data) => json.encode(data.toJson());

///Schema for the UI Schema
class UiSchemaV2Model {
  ///The Metaschema of the UI Schema
  String? schema;
  Layout layout;

  ///Version of the UI Schema. Changes in a major version are backwards compatible. So for a
  ...
  factory UiSchemaV2Model.fromJson(Map<String, dynamic> json) => UiSchemaV2Model(
        schema: json["\u0024schema"],
...
class Layout {
  ...
  factory Layout.fromJson(Map<String, dynamic> json) => Layout(
        ...
        options: json["options"] == null
            ? null
            : LayoutOptions.fromJson(json["options"]),
        showOn: json["showOn"] == null
            ? null
            : ShowOnProperty.fromJson(json["showOn"]),
...
final theButtonsTypeValues = EnumValues(
    {"reset": TheButtonsType.RESET, "submit": TheButtonsType.SUBMIT});
...
class Button {
  ...
  factory Button.fromJson(Map<String, dynamic> json) => Button(
        ...
        options: json["options"] == null
            ? null
            : ButtonOptions.fromJson(json["options"]),
        showOn: json["showOn"] == null
            ? null
            : ShowOnProperty.fromJson(json["showOn"]),
        text: json["text"],
...
class ButtonOptions {
  ...
  factory ButtonOptions.fromJson(Map<String, dynamic> json) => ButtonOptions(
        ...
        nativeSubmitOptions: json["nativeSubmitOptions"] == null
            ? null
            : NativeSubmitSettings.fromJson(json["nativeSubmitOptions"]),
...
class NativeSubmitSettings {
  ...
  factory NativeSubmitSettings.fromJson(Map<String, dynamic> json) =>
      NativeSubmitSettings(
...
final formenctypeValues = EnumValues({
  "application/x-www-form-urlencoded":
      Formenctype.APPLICATION_X_WWW_FORM_URLENCODED,
...
final formmethodValues =
    EnumValues({"get": Formmethod.GET, "post": Formmethod.POST});

///Specifies where to display the response after submitting the form
enum Formtarget { BLANK, PARENT, SELF, TOP }
...
class Options {
    ...
    Map<String, DescendantControlOverride>? descendantControlOverrides;
    ...
    factory Options.fromJson(Map<String, dynamic> json) => Options(
        ...
        cssClass: json["cssClass"],
        descendantControlOverrides: Map.from(json["descendantControlOverrides"] ?? {}).map((k, v) => MapEntry<String, DescendantControlOverride>(k, DescendantControlOverride.fromJson(v))),
...
//             Map.from(json["descendantControlOverrides"]!).map((k, v) =>
//                 MapEntry<String, DescendantControlOverride>(
//                     k, DescendantControlOverride.fromJson(v))),
//         disabled: json["disabled"],
//         displayAs: displayAsValues.map[json["displayAs"]]!,
//         enumTitles: Map.from(json["enumTitles"]!)
...
//         "autocomplete": autocompleteValuesValues.reverse[autocomplete],
//         "cssClass": cssClass,
//         "descendantControlOverrides": Map.from(descendantControlOverrides!)
//             .map((k, v) => MapEntry<String, dynamic>(k, v.toJson())),
//         "disabled": disabled,
//         "displayAs": displayAsValues.reverse[displayAs],
//         "enumTitles": Map.from(enumTitles!)
//             .map((k, v) => MapEntry<String, dynamic>(k, v)),
//         "format": formatValues.reverse[format],
//         "hidden": hidden,
//         "label": label,
...
class DescendantControlOverride {
  Options? options;
  ShowOnProperty? showOn;
  ...
  factory DescendantControlOverride.fromJson(Map<String, dynamic> json) =>
      DescendantControlOverride(
        options:
            json["options"] == null ? null : Options.fromJson(json["options"]),
        showOn: json["showOn"] == null
...
///Choose how an enum should be displayed
enum DisplayAs { RADIOBUTTONS, SELECT, SWITCHES }
...
//   });
//
//   factory ShowOnClass.fromJson(Map<String, dynamic> json) => ShowOnClass(
//         path: json["path"],
//         referenceValue: json["referenceValue"],
//         type: showOnFunctionTypeValues.map[json["type"]]!,
//       );
